...
mapshaper-xl 5gb \
-i '/Users/cervas/My Drive/GitHub/Data Files/GIS/Tigerline/TIGER2020PL/blocks/FL/tl_2020_47_tabblock20.shp' name=blocks \
...
Code to create maps for expert wiFLess reports


```
mapshaper -i blocks_simplified/FL_blocks20_simplified.json name=blocks \
  -proj EPSG:3662 \
  ...
  -o '/Users/cervas/Downloads/FL_blocks.svg' format=svg combine-layers
```
...
![](FL_Senate_enacted.png)
```
mapshaper -i '/Users/cervas/My Drive/GitHub/districting/2022/FL-Lee-v-Moore/Other Plans/Senate 2022 Enacted/FL-Senate-enacted.geojson' name=enacted \
  -proj EPSG:2274 \
  ...
  -i '/Users/cervas/My Drive/GitHub/districting/2022/FL-Lee-v-Moore/Illustrative-Plans/Senate Concept 1/concept1.geojson' name=concept1 \
  -proj EPSG:2274 \
  ...
  -i '/Users/cervas/My Drive/GitHub/districting/2022/FL-Lee-v-Moore/Illustrative-Plans/Senate Concept 1a/concept1a.geojson' name=concept1a \
  -proj EPSG:2274 \
  ...
  -i '/Users/cervas/My Drive/GitHub/districting/2022/FL-Lee-v-Moore/Illustrative-Plans/Senate Concept 1b/concept1b.geojson' name=concept1b \
  -proj EPSG:2274 \
  ...
  -i '/Users/cervas/My Drive/GitHub/districting/2022/FL-Lee-v-Moore/Other Plans/Senate-Constitutional-Numbering-Map/sendems.geojson' name=sendems \
  -proj EPSG:2274 \
  ...
  -i '/Users/cervas/My Drive/GitHub/Data Files/Census/FL2020.pl/GIS/counties/FL_counties20.shp' name=counties \
  -proj EPSG:2274 \
  ...
  -o target="enacted_zoom,enacted-lines,davidson,enacted-district-labels,county-labels" '/Users/cervas/Downloads/FL/FL_Senate_enacted.svg' format=svg combine-layers \
  -o target="sendems_zoom,sendems-lines,davidson,sendems-district-labels,county-labels" '/Users/cervas/Downloads/FL/FL_Senate_sendems.svg' format=svg combine-layers \
  -o target="concept1_zoom,concept1-lines,davidson,concept1-district-labels,county-labels" '/Users/cervas/Downloads/FL/FL_Senate_concept1.svg' format=svg combine-layers \
  -o target="concept1a_zoom,concept1a-lines,davidson,concept1a-district-labels,county-labels" '/Users/cervas/Downloads/FL/FL_Senate_concept1a.svg' format=svg combine-layers \
  -o target="concept1b_zoom,concept1b-lines,davidson,concept1b-district-labels,county-labels" '/Users/cervas/Downloads/FL/FL_Senate_concept1b.svg' format=svg combine-layers \
  ...
  -dissolve target=counties STATEFP no-replace name=FL \
  -style target=FL fill=none stroke=#000 \
  ...
  -o target="counties-lines,enacted_zoom-area,FL" '/Users/cervas/Downloads/FL/FL_Senate_enacted_st.svg' format=svg combine-layers width=200 \
  -o target="counties-lines,concept1_zoom-area,FL" '/Users/cervas/Downloads/FL/FL_Senate_concepts_st.svg' format=svg combine-layers width=200 \
  -o target="counties-lines,enacted,FL" '/Users/cervas/Downloads/FL/FL_Senate_enacted.svg' format=svg combine-layers \
  -o target="counties-lines,sendems,FL" '/Users/cervas/Downloads/FL/FL_Senate_sendems.svg' format=svg combine-layers \
  -o target="counties-lines,concept1,FL" '/Users/cervas/Downloads/FL/FL_Senate_concept1.svg' format=svg combine-layers \
  -o target="counties-lines,concept1a,FL" '/Users/cervas/Downloads/FL/FL_Senate_concept1a.svg' format=svg combine-layers \
  -o target="counties-lines,concept1b,FL" '/Users/cervas/Downloads/FL/FL_Senate_concept1b.svg' format=svg combine-layers \
  -o target="counties-lines,urban,FL,county-labels-urban" '/Users/cervas/Downloads/FL/FL_House-urban.svg' format=svg combine-layers
```
...
plan_sum <- function(plan=NULL) {
  ...
  plan_tmp <- merge(plan, FL_blocks, by.x="GEOID20", by.y="GEOCODE")
  ...
  FLsplits_tmp <- do.call(rbind, data_new)
  FLsplits <- FLsplits_tmp[(FLsplits_tmp$x < 66316),]
...
splits.table <- 
  rbind(
    ...
    length(aggregate(FLsplits$x, by=list(FLsplits$COUNTY), FUN=sum)[,1]),
    min(dist_pop$TOTAL),
...
FL_blocks <- read.csv("/Volumes/GoogleDrive/My Drive/GitHub/Data Files/Census/FL2020.pl/clean data/FL_blocks.csv")

House13a <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13a/FL House 13a.csv")
House13b <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13b/FL House 13b.csv")
House13.5a <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13.5a/FL House 13.5a.csv")
House13.5b <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13.5b/FL House 13.5b.csv")
House14a <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/14a/FL House 14a.csv")

demconcept <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/House Dem Concept 12-15-21/House Dem Concept 12-15-21.csv")
enacted <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/2022 Enacted/2022 Enacted.csv")


FL13b_err <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/response_report/FL House 13b_erratum.csv", colClasses=c("character"))
FL14a_err <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/response_report/FL House 14a_erratum.csv", colClasses=c("character"))
FL13.5a_err <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/response_report/FL House 13.5a_erratum.csv", colClasses=c("character"))
FL13.5b_err <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/response_report/FL House 13.5b_erratum.csv", colClasses=c("character"))
FL13c <- read.csv("/Users/cervas/Library/Mobile Documents/com~apple~CloudDocs/Downloads/FL House 13c.csv", colClasses=c("character"))
FL13d <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13d/FL House 13d.csv", colClasses=c("character"))
FL13d_e <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13d_e/FL House 13d_e.csv", colClasses=c("character"))

FL13e <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13e/FL House 13e.csv", colClasses=c("character"))


plan <- read.csv("/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13d_e/FL House 13d_e.csv", colClasses=c("character"))
plan_sum(plan)
...
plan_sum(FL13b_err)
plan_sum(FL14a_err)
plan_sum(FL13.5a_err)
plan_sum(FL13.5b_err)
plan_sum(FL13c)
plan_sum(FL13d)
plan_sum(FL13e)
```
...
```{r}
FL13b <- cbind(House13b[order(House13b[,1]),], FL13b_err[order(FL13b_err[,1]),])
FL14a <- cbind(House14a[order(House14a[,1]),], FL14a_err[order(FL14a_err[,1]),])
FL135a <- cbind(House13.5a[order(House13.5a[,1]),], FL13.5a_err[order(FL13.5a_err[,1]),])
FL135b <- cbind(House13.5b[order(House13.5b[,1]),], FL13.5b_err[order(FL13.5b_err[,1]),])

diff_geo <- function(a) {
changes.blocks <- cbind(a[,1][!(a[,2] == a[,4])], a[,2][!(a[,2] == a[,4])])
colnames(changes.blocks) <- c("GEOID20","District")

changes.tmp <- merge(changes.blocks, FLblocks, by="GEOID20")
...
mapshaper -i '/Volumes/GoogleDrive/My Drive/GitHub/Data Files/GIS/USA_Major_Cities.geojson' name=cities \
  ...
  -i '/Volumes/GoogleDrive/My Drive/GitHub/Data Files/Census/FL2020.pl/GIS/counties/FL_counties20.shp' name=counties \
  -filter target=cities '["FL"].indexOf(ST) > -1' \
  -filter target=cities-label '["FL"].indexOf(ST) > -1' \
  ...
  -dissolve target=counties STATEFP no-replace name=FL \
  -style target=FL fill=none stroke=#000 \
  -o target="FL,cities,cities-label" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps
86C,#FF7538,#FF2B2B,#F8D568,#E6A8D7,#414A4C,#FF6E4A,#1CA9C9,#FFCFAB,#C5D0E6,#FDDDE6,#158078,#FC74FD,#F78FA7,#8E4585,#7442C8,#9D81BA,#FE4EDA,#FF496C,#D68A59,#714B23,#FF48D0,#E3256B,#EE204D,#FF5349,#C0448F,#1FCECB,#7851A9,#FF9BAA,#FC2847,#66FF66,#9FE2BF,#A5694F,#8A795D,#45CEA2,#FB7EFD,#CDC5C2,#80DAEB,#ECEABE,#FFCF48,#FD5E53,#FAA76C,#18A7B5,#EBC7DF,#FC89AC,#DBD7D2,#17806D,#DEAA88,#77DDE7,#FFFF83,#926EAE,#324AB2,#F75394,#FFA089,#8F509D,#A2ADD0,#FF43A4,#FC6C85,#CDA4DE,#FFFF00,#C5E384,#FFAE42" \
  ...
  -o target="Shelby,enacted-district-labels,enacted" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/Zoom/FL_House_enacted.svg' format=svg combine-layers height=200 \
  -o target="Shelby,13.5a-district-labels,13.5a" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/Zoom/FL_House_13.5a.svg' format=svg combine-layers height=200 \
  -o target="Shelby,13.5b-district-labels,13.5b" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/Zoom/FL_House_13.5b.svg' format=svg combine-layers height=200 \
  -o target="Shelby-Tipton,14a-district-labels,14a" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/Zoom/FL_House_14a.svg' format=svg combine-layers height=200
```

```
mapshaper \
  -i '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/2022 Enacted/2022 Enacted.geojson' name=enacted \
  -i '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13a/FL House 13a.geojson' name=13a \
  -i '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13b/FL House 13b.geojson' name=13b \
  -i '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/14a/FL House 14a.geojson' name=14a \
  -i '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13.5a/FL House 13.5a.geojson' name=13.5a \
  -i '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13.5b/FL House 13.5b.geojson' name=13.5b \
  -i '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13c/FL House 13c.geojson' name=13c \
  -i '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/13d/FL House 13d.geojson' name=13d \
  -i '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/House Plans/House Dem Concept 12-15-21/House Dem Concept 12-15-21.geojson' name=demconcept \
  -i '/Volumes/GoogleDrive/My Drive/GitHub/Data Files/Census/FL2020.pl/GIS/counties/FL_counties20.shp' name=counties \
  ...
  -o target="enacted,counties-lines,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/FL_House_enacted.svg' format=svg combine-layers height=200 \
  -o target="13a,counties-lines,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/FL_House_13a.svg' format=svg combine-layers height=200 \
  -o target="13b,counties-lines,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/FL_House_13b.svg' format=svg combine-layers height=200 \
  -o target="demconcept,counties-lines,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/FL_House_demconcept.svg' format=svg combine-layers height=200 \
  -o target="14a,counties-lines,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/FL_House_14a.svg' format=svg combine-layers height=200 \
  -o target="13.5a,counties-lines,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/FL_House_13.5a.svg' format=svg combine-layers height=200 \
  -o target="13.5b,counties-lines,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/FL_House_13.5b.svg' format=svg combine-layers \
  -o target="13c,counties-lines,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/FL_House_13c.svg' format=svg combine-layers \
  -o target="13d,counties-lines,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/Plans/FL_House_13d.svg' format=svg combine-layers \
  ...
  -o target="counties-lines,sameenacted,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/House/FL_House_sameenacted.svg' format=svg combine-layers height=200 \
  ...
  -o target="counties-lines,Black14a,FL" '/Users/cervas/Library/Mobile Documents/com~apple~CloudDocs/Downloads/black14a.svg' format=svg combine-layers height=200 \
```
...
```
  -style target=FL fill=none stroke=#e6e6e6 stroke-width=3 stroke-opacity=0.70 \
  ...
  -o target="counties-lines,map,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/Senate/FL_Senate-Constitutional-Numbering-Map.svg' format=svg combine-layers \
  -i '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Senate Plans/Concept 1/Concept-1/Concept-1.shp' name=map1 \
  ...
  -o target="counties-lines,map1,FL" '/Volumes/GoogleDrive/My Drive/Projects/Redistricting/2022/FL/Maps/Senate/FL_Senate-Concept-1.svg' format=svg combine-layers
