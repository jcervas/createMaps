...
-o target=counties-styled,urban,counties,counties-labels,us-cart '/Users/cervas/Library/CloudStorage/GoogleDrive-jcervas@andrew.cmu.edu/My Drive/GitHub/createMaps/PA/images/PA_counties-styled.svg' \
```
...
Senate District Map:
```
-filter target=senate2021 "TotalPop>='0'" + name=senate2021-districts \
-classify save-as=fill colors=Category20 non-adjacent \
-dissolve field=fill copy-fields=fill \
-style opacity=0.75 \
