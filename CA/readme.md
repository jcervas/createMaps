...
# 2022 California Congressional Map
![](images/cd2022.svg)

# 2026 California Congressional Map
![](images/cd2026.svg)
...
```
cd '/Users/cervas/Library/CloudStorage/GoogleDrive-jcervas@andrew.cmu.edu/My Drive/GitHub/createMaps/CA'

mapshaper \
-i 'GIS/tl_2025_06_tract.json' name=tracts \
-filter "ALAND>'0'" \
...
```
-i 'GIS/CA-2022.geojson' name=cd2022 \
-i 'GIS/CA-2026.geojson' name=cd2026 \
...
Project all layers
```
-proj target=tracts,counties,cities,cd2022,cd2026 EPSG:3310 \
```
